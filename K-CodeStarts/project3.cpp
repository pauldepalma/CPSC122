...
#include <fstream>
using namespace std;
//Note that variable names in the next three statements are for documentation purposes only
...
int main(int argc, char* argv[])
{
 ...
 //Notice input and output are slightly different than for project 3
//In project 2 the plaintext file is always before the ciphertext file.
//Here the input file is alwayw first
 if (argc == 5)
  {
   input = argv[3];
   output = argv[4];
